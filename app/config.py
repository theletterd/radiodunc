...
class StationConfig(BaseModel):
    ...
    dj_prompt_template: str | None = Field(
        ...
        description=(
            ...
            "{handoff_block} fires on the first prompt after the active (dj_id, show_id) "
            "tuple changes — i.e. when a show takeover just happened on air — directing "
            "the new DJ to open with a live handoff line (\"thanks <prev>, you're with "
            "<you> on <show> now\"). Empty otherwise; suppresses {self_id_block} when it "
            "fires (a takeover already self-IDs). "
